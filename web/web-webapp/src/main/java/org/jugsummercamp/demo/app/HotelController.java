...
import org.jugsummercamp.demo.api.Hotel;
import org.jugsummercamp.demo.api.HotelProvider;
import org.jugsummercamp.demo.fwk.api.Controller;
...
public class HotelController implements Controller {
    ...
    @GET @Path("hotels") @Produces(MediaType.APPLICATION_JSON)
    ...
    @GET @Path("hotels/{id}") @Produces(MediaType.APPLICATION_JSON)
    ...
    @GET @Path("book") @Produces(MediaType.TEXT_PLAIN)
    ...
    @GET @Path("countries") @Produces(MediaType.TEXT_PLAIN)
    ...
    @GET @Path("countries/{country}") @Produces(MediaType.APPLICATION_JSON)
    ...
    @GET @Path("none") @Produces(MediaType.TEXT_PLAIN)
    public String none() {
        if (app.isValid()) {
            return "false";
        }
